...
def test_merge_deposit_files():
    ...
    with tempfile.NamedTemporaryFile('w', delete=False) as file1, tempfile.NamedTemporaryFile('w', delete=False) as file2, tempfile.NamedTemporaryFile('w', delete=False) as merged_file:
        ...
        with open(merged_file.name, 'r') as result:
